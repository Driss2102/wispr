import React, { useState, useId, Fragment, useRef } from 'react';
...
/** Accessible FAQ accordion that also emits FAQPage JSON-LD (rich results). */
export default function FAQAccordion({
  ...
  /** Renders answer text with [label](href) turned into real links. */
